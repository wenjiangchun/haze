...
public class ProcessDefinitionService {
	...
	@Transactional(readOnly = true)
	public void activateProcessDefinitionById(String processInstanceId,
			boolean b) {
		repositoryService.activateProcessDefinitionById(processInstanceId, b, null);
	}
	
	@Transactional(readOnly = true)
	public void suspendProcessDefinitionById(String processInstanceId,
			boolean b) {
		repositoryService.suspendProcessDefinitionById(processInstanceId, b, null);
	}
