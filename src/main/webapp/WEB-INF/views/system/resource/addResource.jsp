...
<body>
	<ul class="breadcrumb">
        ...
        <li class="active"><fmt:message key="add" /><fmt:message key="resource" /></li>
    </ul>
	<form:form id="inputForm" modelAttribute="resource" action="${ctx}/system/resource/save" method="post" class="form-horizontal">
		<fieldset>
			...
			<div class="control-group">
				...
				<div class="controls">
				   <input type="text" id="permission" name="permission"  class="input-large" value="anon"/>
				</div>
			</div>
			<div class="control-group">
				<label for="url" class="control-label"><fmt:message key="resource.url"/>:</label>
				<div class="controls">
					<input type="text" id="url" name="url" class="input-large" placeholder=""/>
				</div>
			</div>
			<div class="control-group">
