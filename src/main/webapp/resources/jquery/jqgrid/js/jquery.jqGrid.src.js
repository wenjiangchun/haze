	...
	return this.each( function() {
		...
		setPager = function (pgid, tp){
			...
			if(ts.p.pgbuttons===true) {
				...
				pgl += "<td id='"+po[0]+"' class=''><a href='#' class='btn'>首页</a></td>";
				pgl += "<td id='"+po[1]+"' class=''><a href='#' class='btn'>上一页</a></td>";
				//pgl += pginp !== "" ? sep+pginp+sep:"";
				pgl += "<td id='"+po[2]+"' class=''><a href='#' class='btn'>下一页</a></td>";
				pgl += "<td id='"+po[3]+"' class=''><a href='#' class='btn'>尾页</a></td>";
