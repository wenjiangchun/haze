...
public class DataTableParames {
	 ...
	 * 自定义查询参数
	 */
	private Map<String,Object> queryVairables;
	...
	public PageRequest getPageRequest() {
		String sortColunmName = sColumns[iSortCol_0];
		Sort sort = new Sort(Sort.Direction.fromString(sSortDir_0),sortColunmName);
